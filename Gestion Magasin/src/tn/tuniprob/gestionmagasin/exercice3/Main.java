...
public class Main {
    public static void main(String[] args) {
        ...
        Caissier caissier1=new Caissier(10,5,"houssem","Sidi bouzid",2);
        Caissier caissier2=new Caissier(11,6,"ilyes","Sidi bouzid",3);
        ...
        Caissier caissier3=new Caissier(10,5,"Houssem","Menzah6",2);
        Caissier caissier4=new Caissier(12,6,"nizar","Menzah6",3);
        Caissier caissier5=new Caissier(13,6,"ilyes","Menzah6",3);
        Vendeur vendeur=new Vendeur(15,8,"wael","Sidi bouzid",50);
